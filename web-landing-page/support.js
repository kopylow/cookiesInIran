...
(function () {
  ...
  // or the visible value and its QR will disagree.
  ...
  // A label/value/copy row (recipient, IBAN, BIC). `display` is
  ...
  // A labelled group of cards (e.g. "Direct support"). Returns the
